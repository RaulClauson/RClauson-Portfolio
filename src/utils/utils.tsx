...
export const friendlyMobile = createImage(
...
export const blueMobile = createImage(
...
export const saborMobile = createImage(
...
// Credits
export const LeoMi = createImage("Portfolio3/VaptVupt/lszcpugrjavhpumheale");
export const Friendly = createImage("Portfolio3/Friendly/gr5xxbfv7vmvlnl3p2g6");
export const Sabordobem = createImage(
  "Portfolio3/Sabordobem/ioghjoyznjtbhvmqwtse"
);
